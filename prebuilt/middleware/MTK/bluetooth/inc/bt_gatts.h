...
/**
*  @brief This structure defines the data type of the callback parameter for the event (#BT_GATTS_CALLBACK_WRITE) which call #bt_gatts_send_response() to send a response.
*/
typedef struct {
