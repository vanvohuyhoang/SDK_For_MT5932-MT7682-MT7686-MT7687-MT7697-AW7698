 ...
 * @{
 * @addtogroup aw7698_evk_apps_httpd httpd
 * @{
...
@par Run the application
  - Build the application with a command "./build.sh aw7698_evk httpd" from
    the SDK root folder and download the binary file to 7698 EVK.
