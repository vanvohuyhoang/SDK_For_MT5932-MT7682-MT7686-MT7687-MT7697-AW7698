...
#if (PRODUCT_VERSION == 7687) || (PRODUCT_VERSION == 7697) || (PRODUCT_VERSION == 7698) || (PRODUCT_VERSION == 7686) || (PRODUCT_VERSION == 7682) || (PRODUCT_VERSION == 5932) || defined(MTK_NO_PSRAM_ENABLE)
...
#define USER_ENTRY_TASK_NAME                   "user entry"
#define USER_ENTRY_TASK_STACKSIZE              (6*1024)
#define USER_ENTRY_TASK_PRIO                   TASK_PRIORITY_NORMAL
/*
#define KA_ENTRY_TASK_NAME                   "user entry"
#define KA_ENTRY_TASK_STACKSIZE              (6*1024)
#define KA_ENTRY_TASK_PRIO                   TASK_PRIORITY_NORMAL
#define RT_ENTRY_TASK_NAME                   "user entry"
#define RT_ENTRY_TASK_STACKSIZE              (6*1024)
#define RT_ENTRY_TASK_PRIO                   TASK_PRIORITY_NORMAL
*/
