 ...
 * @{
 * @addtogroup aw7698_evk_apps_mbedtls mbedtls
 * @{
...
@par Run the application
  - Build the application with the command "./build.sh aw7698_evk mbedtls"
    from the SDK root folder and download the binary file to the 7698 EVK
    board.
