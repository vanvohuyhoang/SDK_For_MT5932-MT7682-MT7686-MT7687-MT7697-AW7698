 ...
 * @{
 * @addtogroup aw7698_evk_apps_xml xml
 * @{
...
@par Run the application
  - Build the application with the command, "./build.sh aw7698_evk xml" from
    the SDK root folder and download the bin file to 7698 EVK.
