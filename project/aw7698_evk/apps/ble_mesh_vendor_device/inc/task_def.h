...
#define MESH_GATEWAY_TCP_TASK_STACKSIZE              (1024 * 4)
#define MESH_GATEWAY_TCP_TASK_PRIO                   TASK_PRIORITY_NORMAL

/* for mesh app latency/throughput/packet loss task */
#define MESH_APP_TASK_NAME                   "mesh_app_test"
#define MESH_APP_TASK_STACKSIZE              (512 * 4)
