...
LOG_CONTROL_BLOCK_DECLARE(BTA2DP);
LOG_CONTROL_BLOCK_DECLARE(BTAVM);
LOG_CONTROL_BLOCK_DECLARE(BTAVRCP);
LOG_CONTROL_BLOCK_DECLARE(BTAWS);
LOG_CONTROL_BLOCK_DECLARE(BTCOMMON);
LOG_CONTROL_BLOCK_DECLARE(BTGAP);
LOG_CONTROL_BLOCK_DECLARE(BTGATT);
LOG_CONTROL_BLOCK_DECLARE(BTGOEP);
LOG_CONTROL_BLOCK_DECLARE(BTHID);
LOG_CONTROL_BLOCK_DECLARE(BTAIRUPDATE);
LOG_CONTROL_BLOCK_DECLARE(BTHFP);
LOG_CONTROL_BLOCK_DECLARE(BTHSP);
LOG_CONTROL_BLOCK_DECLARE(BTATT);
LOG_CONTROL_BLOCK_DECLARE(BTPBAPC);
LOG_CONTROL_BLOCK_DECLARE(BTSDP);
...
log_control_block_t *syslog_control_blocks[] = {
    ...
    &LOG_CONTROL_BLOCK_SYMBOL(BWCS_BT),
    &LOG_CONTROL_BLOCK_SYMBOL(BTA2DP),
    &LOG_CONTROL_BLOCK_SYMBOL(BTAVM),
    &LOG_CONTROL_BLOCK_SYMBOL(BTAVRCP),
    &LOG_CONTROL_BLOCK_SYMBOL(BTAWS),
    &LOG_CONTROL_BLOCK_SYMBOL(BTCOMMON),
    &LOG_CONTROL_BLOCK_SYMBOL(BTGAP),
    &LOG_CONTROL_BLOCK_SYMBOL(BTGATT),
    &LOG_CONTROL_BLOCK_SYMBOL(BTGOEP),
    &LOG_CONTROL_BLOCK_SYMBOL(BTHID),
    &LOG_CONTROL_BLOCK_SYMBOL(BTAIRUPDATE),
    &LOG_CONTROL_BLOCK_SYMBOL(BTHFP),
    &LOG_CONTROL_BLOCK_SYMBOL(BTHSP),
    &LOG_CONTROL_BLOCK_SYMBOL(BTATT),
    &LOG_CONTROL_BLOCK_SYMBOL(BTPBAPC),
    &LOG_CONTROL_BLOCK_SYMBOL(BTSDP),
    &LOG_CONTROL_BLOCK_SYMBOL(BTSM),
    &LOG_CONTROL_BLOCK_SYMBOL(BTTIMER),
#ifdef __MTK_BT_MESH_ENABLE__ 
